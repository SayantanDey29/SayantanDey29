...
On the generative AI front, I specialize in retrieval-augmented generation (RAG) pipelines, implementing LangChain, LangGraph, and LangSmith with Ollama for controlled inference. I apply semantic chunking, vector similarity search using FAISS, and structured prompting approaches ranging from zero-shot to chain-of-thought reasoning. 

I believe in continuous learning, research-oriented experimentation, and building scalable solutions that deliver real-world impact.
</p>
...
<p align="left">
  <img src="https://komarev.com/ghpvc/?username=sayantandey&label=Profile%20views&color=0e75b6&style=flat" alt="sayantandey" />
</p>
...
- Evaluated algorithms based on accuracy, interpretability, and clinical relevance.
- **Research Paper:** [Springer Link](https://link.springer.com/chapter/10.1007/978-3-031-71125-1_3)
